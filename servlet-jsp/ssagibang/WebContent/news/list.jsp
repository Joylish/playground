...
<head>
	...
	<link href="../css/layout/_news.css" rel="stylesheet">
</head>
<body>
	<div class="header-container shadow">
		...
		<div class="col">
			<div class="card h-100">
				<img src="https://imgnews.pstatic.net/image/421/2021/03/12/0005217728_001_20210312111945474.jpg?type=w647" class="card-img-top" alt="..." />
				<div class="card-body">
					<h5 class="card-title">쌓이는 물량에 서울 아파트 전세 비중 7개월 만에 60%대로 회복</h5>
					<p class="card-text">
						지난달 2만2700여건…임대차2법 시행 전인 7월 수준으로
