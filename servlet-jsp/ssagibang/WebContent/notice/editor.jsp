        ...
        <form action="/action_page.php">
            ...
            <div class="form-group">
                <label for="contents">내용:</label> <input type="text"
                    class="form-control form-control-lg" id="contents">
            </div>
        </form>
        <div class="container text-center">
            <button type="submit" class="btn btn-primary mr-1">글작성</button>
            <button type="submit" class="btn btn-warning mr-1">초기화</button>
