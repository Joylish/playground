            ...
            <h1>싸지방 사이트맵</h1>
                ...
                <div class="row py-4">
                    <div class="col-sm-6">
                        <section id="sec1">
                            <h2>전체 사이트</h2>
                            <li><a href="${root}/index.jsp">메인사이트</a></li>
                            <li><a href="${root}/notice/list.jsp">공지사항</a></li>
                            <li><a href="${root}/news/list.jsp">오늘의 뉴스</a></li>
                            <li><a href="${root}/user/interest.jsp">관심 목록</a></li>
                        </section>
                    </div>
                    <div class="col-sm-6">
                        <section id="sec2">
                            <h2>검색</h2>
                            <li><a href="${root}/index.jsp">내 근처 검색</a></li>
                            <li><a href="${root}/index.jsp">내 근처 아파트 상세 검색</a></li>
                            <li><a href="${root}/index.jsp">내 근처 아파트 아파트별 검색</a></li>
                            <li><a href="${root}/index.jsp">선택지역 아파트 검색</a></li>
                            <li><a href="${root}/index.jsp">선택지역 아파트 주변 환경 검색</a></li>
                            <li><a href="${root}/product/detail.jsp">선택한 매물 상세 정보</a></li>
                          </section>
                    </div>
                </div>
                ...
                <div class="row py-4">
                    <div class="col-sm-6">
                        <section id="sec1">
                            ...
                            <li><a href="${root}/user/mypage.jsp">회원정보확인</a></li>
                            <li><a href="${root}/user/edit_mypage.jsp">회원정보수정</a></li>
                            <li><a href="${root}/user/interest.jsp">관심지역 설정</a></li>
                        </section>
                    </div>
                </div>
